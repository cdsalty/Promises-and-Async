//JS is an async language; 
    // JS/Node only run on one thread at a time.
...
//     get, from the movie data, the cast data              EACH ONE
//         get, from cast data, an individual actor               OF THESE
//             get, individual actor, highest grossing movie         ARE A NEW REQUEST
...
// Basically, in sudo Code   you need to use   
// PSUDO CODE:
// GetMoviesNowPlaying… 
// .then——> get cast of movie
// .then——> get actor info